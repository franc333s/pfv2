...
function ProjectType() {
    ...
    return (
        <>
            ...
            <main className="bg-color-green topbar-offset-padding vertical-padding portfolio">
                
                <div className="portfolio__title portfolio--flex">
                    <h1 className="p--small text-color-black">Which type of projects you'd like to see?</h1>
                </div>
