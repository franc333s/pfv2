            ...
            <main className="topbar-offset-padding vertical-padding bg-color-green">
                ...
                <section className="info__bio">
                    <div className="info__bio__textblock" >
                        ...
                        <p className="p--medium text-color-white">My first contact with the digital world happened 5 years ago when I started as a designer and project manager at an agency. There, I had the opportunity to work along with other designers, web developers and marketing specialists, taking care of the design of online advertisement campaigns and managing digital projects.</p>
